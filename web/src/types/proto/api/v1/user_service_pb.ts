...
/**
 * @generated from message memos.api.v1.SubscribeUserRequest
 */
export type SubscribeUserRequest = Message<"memos.api.v1.SubscribeUserRequest"> & {
  /**
   * Required. The resource name of the user to subscribe to.
   * Format: users/{user}
   *
   * @generated from field: string name = 1;
   */
...
/**
 * Describes the message memos.api.v1.SubscribeUserRequest.
 * Use `create(SubscribeUserRequestSchema)` to create a new message.
 */
export const SubscribeUserRequestSchema: GenMessage<SubscribeUserRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 33);

/**
 * @generated from message memos.api.v1.UnsubscribeUserRequest
 */
export type UnsubscribeUserRequest = Message<"memos.api.v1.UnsubscribeUserRequest"> & {
  /**
   * Required. The resource name of the user to unsubscribe from.
   * Format: users/{user}
   *
   * @generated from field: string name = 1;
   */
...
/**
 * Describes the message memos.api.v1.UnsubscribeUserRequest.
 * Use `create(UnsubscribeUserRequestSchema)` to create a new message.
 */
export const UnsubscribeUserRequestSchema: GenMessage<UnsubscribeUserRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 34);

/**
 * @generated from message memos.api.v1.ListUserSubscriptionsRequest
 */
export type ListUserSubscriptionsRequest = Message<"memos.api.v1.ListUserSubscriptionsRequest"> & {
  /**
   * Required. The parent resource whose subscriptions will be listed.
   * Format: users/{user}
   *
   * @generated from field: string parent = 1;
   */
...
/**
 * Describes the message memos.api.v1.ListUserSubscriptionsRequest.
...
/**
 * @generated from message memos.api.v1.ListUserSubscriptionsResponse
 */
export type ListUserSubscriptionsResponse = Message<"memos.api.v1.ListUserSubscriptionsResponse"> & {
  /**
   * The list of subscriptions.
   *
   * @generated from field: repeated memos.api.v1.UserSubscription subscriptions = 1;
   */
  subscriptions: UserSubscription[];
};

/**
 * Describes the message memos.api.v1.ListUserSubscriptionsResponse.
...
/**
 * @generated from message memos.api.v1.GetUserSubscriptionCountsRequest
 */
export type GetUserSubscriptionCountsRequest = Message<"memos.api.v1.GetUserSubscriptionCountsRequest"> & {
  /**
   * Required. The resource name of the user.
   * Format: users/{user}
   *
...
/**
 * Describes the message memos.api.v1.GetUserSubscriptionCountsRequest.
 * Use `create(GetUserSubscriptionCountsRequestSchema)` to create a new message.
 */
export const GetUserSubscriptionCountsRequestSchema: GenMessage<GetUserSubscriptionCountsRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 37);

/**
 * @generated from message memos.api.v1.UserSubscriptionCounts
 */
export type UserSubscriptionCounts = Message<"memos.api.v1.UserSubscriptionCounts"> & {
  /**
   * The number of followers.
   *
   * @generated from field: int32 follower_count = 1;
   */
...
/**
 * Describes the message memos.api.v1.UserSubscriptionCounts.
 * Use `create(UserSubscriptionCountsSchema)` to create a new message.
 */
export const UserSubscriptionCountsSchema: GenMessage<UserSubscriptionCounts> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 38);

/**
 * @generated from message memos.api.v1.UserSubscription
 */
export type UserSubscription = Message<"memos.api.v1.UserSubscription"> & {
  /**
  ...
  /**
   * The resource name of the user being followed.
   * Format: users/{user}
   *
   * @generated from field: string followed_user = 2;
   */
  followedUser: string;

  /**
   * The resource name of the user following.
   * Format: users/{user}
   *
   * @generated from field: string following_user = 3;
   */
...
/**
 * Describes the message memos.api.v1.UserSubscription.
...
export const UserService: GenService<{
   ...
   *
   * @generated from rpc memos.api.v1.UserService.SubscribeUser
   */
  subscribeUser: {
    methodKind: "unary";
    input: typeof SubscribeUserRequestSchema;
    output: typeof EmptySchema;
  },
  /**
   * UnsubscribeUser removes a subscription (unfollow) relationship.
   *
   * @generated from rpc memos.api.v1.UserService.UnsubscribeUser
   */
  unsubscribeUser: {
    methodKind: "unary";
    input: typeof UnsubscribeUserRequestSchema;
    output: typeof EmptySchema;
  },
  /**
   * ListUserSubscriptions lists the followers or following users of a user.
   *
   * @generated from rpc memos.api.v1.UserService.ListUserSubscriptions
   */
   ...
   *
   * @generated from rpc memos.api.v1.UserService.GetUserSubscriptionCounts
   */
  getUserSubscriptionCounts: {
    methodKind: "unary";
    input: typeof GetUserSubscriptionCountsRequestSchema;
    output: typeof UserSubscriptionCountsSchema;
  },
}> = /*@__PURE__*/
