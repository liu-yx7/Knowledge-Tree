...
export type Memo = Message<"memos.api.v1.Memo"> & {
  ...
  /**
   * Optional. The notebook ID this memo belongs to.
   *
   * @generated from field: int32 notebook_id = 19;
   */
  notebookId: number;
};
