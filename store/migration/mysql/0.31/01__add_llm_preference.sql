...
ALTER TABLE `ragflow_user_mapping` ADD COLUMN `llm_configured` TINYINT(1) NOT NULL DEFAULT 0;
ALTER TABLE `ragflow_user_mapping` ADD COLUMN `preferred_llm_id` VARCHAR(255) NOT NULL DEFAULT '';
ALTER TABLE `ragflow_user_mapping` ADD COLUMN `dataset_ids` TEXT NOT NULL;
