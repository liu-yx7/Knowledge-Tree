...
ALTER TABLE `ragflow_user_mapping` ADD COLUMN `llm_configured` INTEGER NOT NULL DEFAULT 0;
ALTER TABLE `ragflow_user_mapping` ADD COLUMN `preferred_llm_id` TEXT NOT NULL DEFAULT '';
