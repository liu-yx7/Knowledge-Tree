...
ALTER TABLE ai_message ADD COLUMN reasoning_content TEXT NOT NULL DEFAULT '';

-- references_json: 引用文档 JSON
-- 格式: [{"memo_uid":"...","type":"memo","content_snippet":"...","similarity":0.85}]
ALTER TABLE ai_message ADD COLUMN references_json TEXT NOT NULL DEFAULT '';

-- token_usage_json: Token 使用统计（OpenAI 格式）
-- 格式: {"prompt_tokens":100,"completion_tokens":50,"total_tokens":150}
ALTER TABLE ai_message ADD COLUMN token_usage_json TEXT NOT NULL DEFAULT '';
